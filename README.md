...
-   **Automatic Metadata Extraction:** Reads the original capture time from both photos and videos.
-   **Smart Categorization:** Automatically groups media files based on their timestamp.
-   **Custom Folder Formats:** Define how you want your folders named (e.g., `YYYY-MM-DD`, `YYYY/MM/Event`, etc.).
-   **WinUI 3.0 Interface:** A sleek, native Windows 11-style user experience.
-   **Batch Processing:** Handle thousands of photos in seconds.
...
-   **WinUI 3.0** (Windows App SDK)
-   **.NET / C#**

---
*Organize your memories, one click at a time.*
